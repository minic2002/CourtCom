...
<body class="bg-container">
        ...
        $query = "SELECT book_court.bcrt_id, court.court_name, book_court.Start_Time, book_court.End_Time, book_court.Booking_Date, book_court.Booking_Status FROM book_court JOIN court ON book_court.court_id = court.court_ID WHERE book_court.user_id = {$_SESSION['user_id']}";
        $result = mysqli_query($conn, $query);

        if ($result) {
            echo '<table class="table table-striped">';
            echo '<thead><tr><th scope="col">Booking ID</th><th scope="col">Court Name</th><th scope="col">Start Time</th><th scope="col">End Time</th><th scope="col">Booking Date</th><th scope="col">Booking Status</th><th scope="col">Action</th></tr></thead><tbody>';
