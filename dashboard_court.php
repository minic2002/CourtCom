...
<html>
	<head>
		...
		<title>CourtCom | Court Dashboard </title>
	...
	<div class="container-xl">
	  <a class="navbar-brand" href="dashboard_court"><img src="static/images/CourtCom_Logo_more_stroke.png" width="135"></a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarsExample07XL">
		<ul class="navbar-nav me-auto mb-2 mb-lg-0">
		  <li class="nav-item">
			<a class="nav-link active" aria-current="page" href="dashboard_court">Main</a>
		  </li>
		  <li class="nav-item">
