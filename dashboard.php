	...
	<body class="bg-container">
				...
				<div class="collapse navbar-collapse" id="navbarsExample07XL">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown">
							<a class="nav-link" href="#" id="categoriesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								Category
							</a>
		...
		<div >
			...
			<div class="carousel-indicators">
				...
				include "userdb.php";
				// Your query here
				$query = "SELECT court.court_id, court.court_name, court.court_image, users.fname, users.lname, ROUND(AVG(review_court.rate), 1) AS total_rating FROM court INNER JOIN users ON court.user_ID = users.user_id INNER JOIN review_court ON review_court.court_id = court.court_id GROUP BY court.court_id, court.court_name, court.court_image, users.fname, users.lname HAVING AVG(review_court.rate) >= 3.8 ORDER BY AVG(review_court.rate) DESC";
				...
				?>
					<div class="carousel-item <?php echo $active; ?>">
						...
						<div class="carousel-caption text-start">
							<h1><?php echo strtoupper($row['court_name']) . ' <span class="fa fa-star"></span> ' . $row['total_rating']; ?></h1>
