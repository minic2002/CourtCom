    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <button class="btn btn-success" title="Change Payment Status" onclick="court_change_payment_status('<?php echo $bcrt_id; ?>')">
            <i class="fa fa-exchange"></i>
          </button>
          </td>
          <td>
            <button class="btn btn-danger" title="Delete Booking" onclick="court_delete_book('<?php echo $bcrt_id; ?>')">
