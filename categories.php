...
<html>
	<head>
		...
		<title>CourtCom | Category - <?php echo $category; ?> </title>
	...
	<body class="bg-container">
        ...
        <br>
        <!--DISPLAY CATEGORIES-->
        <?php $up_category = strtoupper($category);?>
        <h2 class="text-center"><?php echo $up_category; ?></h2>
        <br>

		<!--DISPLAY COURTS-->
		<?php
		// Your query here
		$query = "SELECT court.court_id, court.court_name, court.court_image FROM court JOIN users ON court.user_ID = users.user_id WHERE court_type = '$category'";
